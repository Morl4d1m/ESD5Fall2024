// code is identical to clockSynchronizationESP32, except for the change in data output after 30 seconds.
...
} esp32MasterFaultyMessage_t;

esp32MasterFaultyMessage_t outgoingFaultyMessage;  // Storage for struct
