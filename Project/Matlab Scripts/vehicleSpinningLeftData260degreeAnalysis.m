angleData = readtable("C:\Users\Christian Lykke\Documents\MATLAB\vehicleSpinningLeftData260degree.xlsx");

% Extract time (column 1), angle (column 2) and difference in angle (column
% 3)
timeSteps = table2array(angleData(1:488, 1));         % Extract time as an array
angleDegrees = table2array(angleData(1:488, 4)); % Extract angle in degrees as an array
angleDifference = table2array(angleData(1:488, 3));
