% Load Video
videoFile = 'C:\Users\Christian Lykke\Documents\Skole\Aalborg Universitet\ESD5\Project\Videoer\difference13TopViewopForMatlab.mp4';
...
writetable(dataTable, 'vehicleTurningData13.csv');

% Optionally, save the data as a MAT file for easier reloading in MATLAB
save('vehicleTurningData13.mat', 'dataTable');