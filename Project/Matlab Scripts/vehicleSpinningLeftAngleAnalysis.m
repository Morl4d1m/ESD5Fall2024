% Load Video
videoFile = 'C:\Users\Christian Lykke\Documents\Skole\Aalborg Universitet\ESD5\Project\Videoer\turningLeftAroundAxisForMatlab1Rotation.mp4';
...
initialDirection = [1, -1];  % This represents a horizontal line (x-axis)
...
writetable(dataTable, 'vehicleSpinningLeftData.csv');

% Optionally, save the data as a MAT file for easier reloading in MATLAB
save('vehicleSpinningLeftData.mat', 'dataTable');