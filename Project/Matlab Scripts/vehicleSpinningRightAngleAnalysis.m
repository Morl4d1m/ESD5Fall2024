% Load Video
videoFile = 'C:\Users\Christian Lykke\Documents\Skole\Aalborg Universitet\ESD5\Project\Videoer\vehicleSpinningRightForMatlab.mp4';
...
writetable(dataTable, 'vehicleSpinningRightData.csv');

% Optionally, save the data as a MAT file for easier reloading in MATLAB
save('vehicleSpinningRightData.mat', 'dataTable');