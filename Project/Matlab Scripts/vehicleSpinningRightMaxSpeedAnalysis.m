% Load Video
videoFile = 'C:\Users\Christian Lykke\Documents\Skole\Aalborg Universitet\ESD5\Project\Videoer\vehicleSpinningRightMaxSpeedForMatlab.mp4';
...
initialDirection = [1, 0];  % This represents a horizontal line (x-axis)
...
writetable(dataTable, 'vehicleSpinningRightMaxSpeedData.csv');

% Optionally, save the data as a MAT file for easier reloading in MATLAB
save('vehicleSpinningRightMaxSpeedData.mat', 'dataTable');