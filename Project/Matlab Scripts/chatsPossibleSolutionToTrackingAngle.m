% Load Video
videoFile = 'C:\Users\Christian Lykke\Documents\Skole\Aalborg Universitet\ESD5\Project\Videoer\difference07TopViewForMatlab.mp4';
...
writetable(dataTable, 'vehicleTurningData.csv');

% Optionally, save the data as a MAT file for easier reloading in MATLAB
save('vehicleTurningData.mat', 'dataTable');